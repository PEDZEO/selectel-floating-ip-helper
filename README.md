...
Проект сделан для образовательных целей и предоставляется как есть.

Автор не несет никакой ответственности за любые последствия использования: удаленные IP, расходы, блокировки, ошибки настройки, потерю доступа, лимиты API или другие проблемы.

Перед запуском разберитесь, что делает каждая команда. Если вы не можете самостоятельно понять настройки, код и последствия запуска, используйте проект только после дополнительной проверки на своей стороне.
